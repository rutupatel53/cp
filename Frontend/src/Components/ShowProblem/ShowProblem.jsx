          ...
          <div>
            <div class="example">
              ...
              <div class="example-content">
                <div>
                  <span class="example-heading">Input: </span>
                  <p class="example-p">nums = [2,7,11,15], target = 9</p>
                </div>
                <div>
                  <span class="example-heading">Output: </span>
                  <p class="example-p">[0,1], target = 9</p>
                </div>
                <div>
                  <span class="example-heading">Explanation: </span>
                  <p class="example-p">
